...
$contact					=	"	<link rel=\"stylesheet\" type=\"text/css\" href=\"css/contact.css\"/>\n";
...
if($the_page == 'home'){
	...
	elseif ($the_page == ('about') || $the_page == ('modern_kitchens') || $the_page == ('classic_kitchens') || 
	$the_page == ('contemporary_kitchens') || $the_page == ('traditional_kitchens') || $the_page == ('kitchen_fitting_costs')) {
		echo $main;
	...
	elseif($the_page == 'contact'){
		echo $main;
		echo $other_start_comment;
		echo $body.$contact.$contact_forms;
		echo $other_end_comment	;
	}
