...
// BD KEIGHLEY.
// BD21 Keighley
$nav_keighley			=	'index.php';
// BD22	Cowling, Haworth, Oakworth, Oxenhope
$nav_cowling			=	'cowling.php';
$nav_haworth			=	'haworth.php';
$nav_oakworth			=	'oakworth.php';
$nav_oxenhope			=	'oxenhope.php';
...
$title = "KITCHEN Fitters &amp; Kitchen Installers in ";
		...
		if($the_page == 'areas_covered'){
			echo 'Areas Covered - ' . $title . 'Keighley';
			}		
				// BD21
				...
				elseif($the_page == 'cowling'){
					echo $title . 'Cowling, Keighley.';
				}
				elseif($the_page == 'haworth'){
					echo $title . 'Haworth, Keighley.';
				}
				elseif($the_page == 'oakworth'){
					echo $title . 'Oakworth, Keighley.';
				}
				elseif($the_page == 'oxenhope'){
					echo $title . 'Oxenhope, Keighley.';
				}
} // function  end /title
...
$desc = "KITCHEN Fitters &amp; Kitchen Installers in ";
		...
		if($the_page == 'areas_covered'){
			echo 'Areas Covered - ' . $desc . 'Keighley';
			}		
		// BD21
		elseif($the_page == 'keighley'){
			echo $desc . 'Keighley.';
		 ...
		 // BD22	Cowling, Haworth, Oakworth, Oxenhope
		elseif($the_page == 'cowling'){
			echo $desc . 'Cowling, Keighley.';
		}
		elseif($the_page == 'haworth'){
			echo $desc . 'Haworth, Keighley.';
		}
		elseif($the_page == 'oakworth'){
			echo $desc . 'Oakworth, Keighley.';
		}
		elseif($the_page == 'oxenhope'){
			echo $desc . 'Oxenhope, Keighley.';
		}
...
$key = "KITCHEN, Kitchen fitter, Kitchen Installer, kitchens, new kitchens, kitchen designer, designer kitchens, fitted kitchens, kitchens installed ";
		...
		if($the_page == 'areas_covered'){
			echo 'Areas Covered - ' . $key . 'Keighley';
			}		
		// BD21
		elseif($the_page == 'keighley'){
			echo $key . 'Keighley.';
		 ...
		 // BD22	Cowling, Haworth, Oakworth, Oxenhope
		elseif($the_page == 'cowling'){
			echo $key . 'Cowling, Keighley.';
		}
		elseif($the_page == 'haworth'){
			echo $key . 'Haworth, Keighley.';
		}
		elseif($the_page == 'oakworth'){
			echo $key . 'Oakworth, Keighley.';
		}
		elseif($the_page == 'oxenhope'){
			echo $key . 'Oxenhope, Keighley.';
		}
